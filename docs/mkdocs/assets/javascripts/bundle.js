(() => {
  ...
  var Observable = function() {
    function Observable39(subscribe) {
      if (subscribe) {
        this._subscribe = subscribe;
      }
    }
    Observable39.prototype.lift = function(operator) {
      var observable2 = new Observable39();
      observable2.source = this;
      observable2.operator = operator;
      return observable2;
    };
    Observable39.prototype.subscribe = function(observerOrNext, error, complete) {
      var _this = this;
    ...
    Observable39.prototype._trySubscribe = function(sink) {
      try {
    ...
    Observable39.prototype.forEach = function(next, promiseCtor) {
      var _this = this;
    ...
    Observable39.prototype._subscribe = function(subscriber) {
      var _a2;
      return (_a2 = this.source) === null || _a2 === void 0 ? void 0 : _a2.subscribe(subscriber);
    };
    Observable39.prototype[observable] = function() {
      return this;
    };
    Observable39.prototype.pipe = function() {
      var operations = [];
      for (var _i = 0; _i < arguments.length; _i++) {
    ...
    Observable39.prototype.toPromise = function(promiseCtor) {
      var _this = this;
      promiseCtor = getPromiseCtor(promiseCtor);
      return new promiseCtor(function(resolve, reject) {
        var value;
    ...
    Observable39.create = function(subscribe) {
      return new Observable39(subscribe);
    };
    return Observable39;
  }();
  ...
  function watchPrint() {
    return fromEvent(window, "beforeprint").pipe(mapTo(void 0));
  }
  ...
  function setupSearchHighlighter(config4) {
    ...
    return (query) => {
      ...
      return (value) => (0, import_escape_html2.default)(value).replace(match, highlight).replace(/<\/mark>(\s+)<mark[^>]*>/img, "$1");
    };
  }
  ...
  function setupSearchIndex({ config: config4, docs, index: index2 }) {
    ...
    return { config: config4, docs, index: index2, options };
  }
  ...
  function mountSearchQuery(el, { tx$, rx$ }) {
    ...
    return watchSearchQuery(el, { tx$, rx$ }).pipe(tap(internal$), finalize(() => internal$.complete()), map((state) => __spreadValues({ ref: el }, state)));
  }
  ...
  function mountSearchShare(el, options) {
    ...
    return watchSearchShare(el, options).pipe(tap(internal$), finalize(() => internal$.complete()), map((state) => __spreadValues({ ref: el }, state)));
  }
  ...
  function mountSearchSuggest(el, { rx$ }, { keyboard$: keyboard$2 }) {
    ...
    const result$ = rx$.pipe(filter(isSearchResultMessage), map(({ data }) => data));
    return result$.pipe(tap(internal$), finalize(() => internal$.complete()), map(() => ({ ref: el })));
  }
  ...
  function mountSearchHiglight(el, { index$: index$2, location$: location$2 }) {
    ...
    ]).pipe(map(([index2, url]) => setupSearchHighlighter(index2.config)(url.searchParams.get("h"))), map((fn) => {
      var _a2;
      const nodes = new Map();
  ...
  function mountBackToTop(el, { viewport$: viewport$2, header$: header$2, main$: main$2 }) {
    ...
    return watchBackToTop(el, { viewport$: viewport$2, header$: header$2, main$: main$2 }).pipe(tap(internal$), finalize(() => internal$.complete()), map((state) => __spreadValues({ ref: el }, state)));
  }
